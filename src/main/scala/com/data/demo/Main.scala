...
//  def getSchool(hukouId: T): String = "Student-" + hukouId + "-" + localId
//}
//
//class Person(val name: String) {
//  def sayHello(): Unit = println("Hello, my name is "+ name)
...
//  def sayHello(): Unit = println("wang wange , is "+ name)
//}
//
...
//}
//// View Bounds
//class Party2[T](p1:T, p2:T)(implicit ev$1: T => Person) {
//  def play(): Unit = p1.makeFriends(p2)
//}
//
//// Context Bounds
//class Calculator[T:Ordering](val num1:T, num2:T){
//  def getMax(implicit order: Ordering[T]):T = if(order.compare(num1, num2) > 0 ) num1 else num2
//}
//
